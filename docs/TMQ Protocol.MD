...
FirstAcquirer, HighPriority, DeliveryRequired are not used. Response Required can be used for some situations, server or client may want to know if the sent message is proceed or not. 
