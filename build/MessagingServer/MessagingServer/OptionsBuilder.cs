...
public class OptionsBuilder
{
    ...
    private void LoadClusterFromEnvironment()
    {
        ...
        _options.ClusterMode = Enums.Parse<ClusterMode>(Environment.GetEnvironmentVariable("HORSE_CLUSTER_TYPE") ?? "Scaled", true, EnumFormat.Name);
    ...
    {
        _options.ChannelAutoCreate = bool.Parse(Environment.GetEnvironmentVariable("HORSE_CHANNEL_AUTO_CREATE") ?? "true");
        _options.ChannelAutoDestroy = bool.Parse(Environment.GetEnvironmentVariable("HORSE_CHANNEL_AUTO_DESTROY") ?? "true");
