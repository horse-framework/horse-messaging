...
public class DataConfigurationBuilder
{
    ...
    private TimeSpan _flushInterval = TimeSpan.FromMilliseconds(250);
    private TimeSpan _shrinkInterval = TimeSpan.FromMinutes(15);
    ...
    {
        _autoFlush = false;
        _flushInterval = TimeSpan.FromSeconds(60);
        _instantFlush = true;
        return this;
    }
