...
namespace Horse.Mq
{
    ...
    public interface IMessageDeliveryHandler
    {
        ...
        /// </summary>
        Task<Decision> ReceivedFromProducer(HorseQueue queue, QueueMessage message, MqClient sender);
        ...
        /// </summary>
        Task<Decision> CanConsumerReceive(HorseQueue queue, QueueMessage message, MqClient receiver);

        /// <summary>
        /// After sending message to a receiver.
        /// This method is called for each message and each receiver.
        /// </summary>
        Task<Decision> ConsumerReceived(HorseQueue queue, MessageDelivery delivery, MqClient receiver);

        /// <summary>
        /// After sending message to a receiver.
        /// This method is called for each message and each receiver.
        /// </summary>
        Task<Decision> ConsumerReceiveFailed(HorseQueue queue, MessageDelivery delivery, MqClient receiver);
