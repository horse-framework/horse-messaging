...
namespace Horse.Mq.Data
{
    ...
    public class PersistentDeliveryHandler : IPersistentDeliveryHandler
    {
        ...
        /// <inheritdoc />
        public virtual Task<Decision> CanConsumerReceive(HorseQueue queue, QueueMessage message, MqClient receiver)
        {
            return Task.FromResult(Decision.JustAllow());
        }

        /// <inheritdoc />
        public virtual Task<Decision> ConsumerReceived(HorseQueue queue, MessageDelivery delivery, MqClient receiver)
        {
            return Task.FromResult(Decision.JustAllow());
        }

        /// <inheritdoc />
        public virtual Task<Decision> ConsumerReceiveFailed(HorseQueue queue, MessageDelivery delivery, MqClient receiver)
        {
            return Task.FromResult(Decision.JustAllow());
        }
