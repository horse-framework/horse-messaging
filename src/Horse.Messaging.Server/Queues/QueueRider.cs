...
public class QueueRider
{
    ...
    /// </summary>
    public ArrayContainer<IQueueEventHandler> EventHandlers { get; } = new();

    /// <summary>
    /// Queue authenticators
    /// </summary>
    public ArrayContainer<IQueueAuthenticator> Authenticators { get; } = new();

    /// <summary>
    /// Event handlers to track queue message events
    /// </summary>
    public ArrayContainer<IQueueMessageEventHandler> MessageHandlers { get; } = new();
