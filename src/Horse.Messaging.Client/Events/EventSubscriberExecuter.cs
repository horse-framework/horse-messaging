...
{
    internal class EventSubscriberExecuter : ExecuterBase
    {
        ...
        /// </summary>
        public EventSubscriberExecuter(Type handlerType, IHorseEventHandler handler, Func<IHandlerFactory> handlerFactoryCreator)
        {
